...
/*   Updated: 2022/11/29 16:36:51 by younhwan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Form::FormNotSignedException::FormNotSignedException(const std::string &name) { this->_msg = std::string(name.c_str()) + " is not signed"; }
Form::FormNotSignedException::~FormNotSignedException(void) throw() {}
const char	*Form::FormNotSignedException::what(void) const throw() { return (this->_msg.c_str()); }
